...
namespace Splendor {
    struct challenge{
        unsigned short const point_goal; // 18 prestige points Goal::Points<18>
        unsigned short const turn_limit; // within 18 turns Goal::Limit<18>
        game game_setup;
    };
    namespace Challenges {
        extern challenge const Jacques_Cartier_1_Disc_of_Newfoundland =
